<body oncontextmenu='return false' class='snippet-body'>
    ...
    <div class="col-md-6 mx-auto p-0">
        <div class="card">
            <div class="login-box">
                <div class="login-snip"> <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab"><br>Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Sign Up</label>
                    <div class="login-space">
                        <form method="POST" action="<?= base_url() ?>auth/proseslogin">
                        <div class="login">
                            <div class="group"> <label for="username" class="label"><br>Username</label> 
                                <input id="username" name="username" type="text" class="input" placeholder="Enter your username" value="<?= set_value('username'); ?>"> 
                            </div>
...
<!--                            <div class="foot"> <a href="#">Forgot Password?</a> </div>-->
                        ...
                        <div class="sign-up-form">
                            <div class="group"> <label for="user" class="label">Username</label> <input id="user" type="text" class="input" placeholder="Create your Username" value="<?= set_value('username'); ?>"> </div>
